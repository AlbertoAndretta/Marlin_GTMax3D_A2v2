...
#define CUSTOM_MENU_CONFIG
  ...
  #define CONFIG_MENU_ITEM_1_DESC "Preaquecer ABS"
  #define CONFIG_MENU_ITEM_1_GCODE "M140 S" STRINGIFY(PREHEAT_1_TEMP_BED) "\nM104 S" STRINGIFY(PREHEAT_1_TEMP_HOTEND)
  //#define CONFIG_MENU_ITEM_1_CONFIRM        // Show a confirmation dialog before this action

  #define CONFIG_MENU_ITEM_2_DESC "Preaquecer ASA"
  #define CONFIG_MENU_ITEM_2_GCODE "M140 S" STRINGIFY(PREHEAT_2_TEMP_BED) "\nM104 S" STRINGIFY(PREHEAT_2_TEMP_HOTEND)
  //#define CONFIG_MENU_ITEM_2_CONFIRM

  #define CONFIG_MENU_ITEM_3_DESC "Preaquecer PETG"
  #define CONFIG_MENU_ITEM_3_GCODE "M140 S" STRINGIFY(PREHEAT_3_TEMP_BED) "\nM104 S" STRINGIFY(PREHEAT_3_TEMP_HOTEND)
  //#define CONFIG_MENU_ITEM_3_CONFIRM

  #define CONFIG_MENU_ITEM_4_DESC "Preaquecer FLEX"
  #define CONFIG_MENU_ITEM_4_GCODE "M140 S" STRINGIFY(PREHEAT_4_TEMP_BED) "\nM104 S" STRINGIFY(PREHEAT_4_TEMP_HOTEND)
